...
namespace Fury
{
    public class Input
    {
        public static bool IsKeyPressed(Key key)
        {
            unsafe
            {
                return OpenTK.Windowing.GraphicsLibraryFramework.GLFW.GetKey(
                    ((WindowsWindow)Application.GetApplication().GetWindow().GetNativeWindow()).WindowPtr, 
                    (OpenTK.Windowing.GraphicsLibraryFramework.Keys)key) == OpenTK.Windowing.GraphicsLibraryFramework.InputAction.Press ? true : false;
            }
        }
